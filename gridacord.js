(function ($) {
  ...
  $.fn.gridacord = function (o) {
    ...
    item_desc_pct = o.item_desc_pct === undefined ? 0.30 : o.item_desc_pct;
    ...
    if (verify_integrity(target)) {
      ...
      $(target + " .item").hover(function () {
        ...
        $(this).find(".item_desc").css("width", exp_width * item_desc_pct).
                css("top", -1 * (exp_height * (1 - 0.65)) ).
                css("left", exp_width * (1-item_desc_pct) - (10 * 2)).
                css("padding", 10);
    ...
    function init_grid(target, width, height, item_margin) {
      ...
      $(".item").hover(
        function(){$(this).find(".item_desc").fadeIn({duration: 1000})},
        function(){$(this).find(".item_desc").fadeOut({duration: 400, queue: false})}
      );
